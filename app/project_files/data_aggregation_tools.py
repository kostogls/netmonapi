...
from ..project_files.graph_methods import create_graph_from_AS_relationships
...
AGGREGATE_DATA_FNAME = 'https://raw.githubusercontent.com/sermpezis/ai4netmon/main/data/aggregate_data/asn_aggregate_data_20220720.csv'
